...
pip3 install -r pulp_oci_images/doc_requirements.txt
...
rsync -avzh site/ doc_builder_pulp_oci_images@docs.pulpproject.org:/var/www/docs.pulpproject.org/pulp_oci_images/

# publish to docs.pulpproject.org/pulp_oci_images/en/{release}
rsync -avzh site/ doc_builder_pulp_oci_images@docs.pulpproject.org:/var/www/docs.pulpproject.org/pulp_oci_images/en/"$1"
